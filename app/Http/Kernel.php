...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'canView' => \App\Http\Middleware\SentinelCanView::class,
        'account_manager' => \App\Http\Middleware\SentinelStaffUser::class,
        'client' => \App\Http\Middleware\SentinelClientUser::class,
        'userCanEditClient' => \App\Http\Middleware\UserCanEditClient::class,
        'userCanDeleteClient' => \App\Http\Middleware\UserCanDeleteClient::class,
