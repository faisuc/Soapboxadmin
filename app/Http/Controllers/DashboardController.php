...
class DashboardController extends Controller
{
    ...
    public function test_instagram() {
        ...
        if(session()->get('insta_fb') != '') {
            ...
            $containers = array(
                ...
                array('id'=>"18053609452101940"),
                array('id'=>"18066858793066195"),
                array('id'=>"18070599811034849"),
                array('id'=>"17976065920246990"),
            );
            
            $container_id = $containers[0]['id'];

            echo '/'.$ig_user_id.'/media_publish?creation_id='.$container_id; die();
    ...
    public function callback_instagram() {
        ...
        $fb_connect_url = URL::to('/').'/test_instagram';
